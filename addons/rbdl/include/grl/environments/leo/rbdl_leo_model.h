...
class LeoSandboxModel: public Sandbox
{
  ...
  protected:
    virtual void export_meshup_animation(double time, const Vector &state, const Vector &action = Vector(),
                                         const std::vector<std::string> &aux = std::vector<std::string>()) const;
