...
function control(state, action)
    ...
    if state[2] > spring_pos then
      stiffness = 1.4*2.92/0.17 --(1.27-spring_pos) -- make it 3 times stronger to saturate -10 V bound on action (-4.1V is RL addition required to work against the spring)
